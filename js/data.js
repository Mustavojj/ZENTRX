export const APP_CONFIG = {
    ...
    QUESTS: {
        ...
        level_quests: [
            ...
            { target_level: 10, reward: 10000 }
        ],
        mining_quests: [
            { target_starts: 3, reward: 1000 },
            { target_starts: 5, reward: 2000 },
            { target_starts: 10, reward: 3000 },
            { target_starts: 20, reward: 4000 },
            { target_starts: 30, reward: 5000 },
            { target_starts: 40, reward: 6000 },
            { target_starts: 50, reward: 7000 },
            { target_starts: 75, reward: 8000 },
            { target_starts: 100, reward: 10000 }
        ]
    }
};
